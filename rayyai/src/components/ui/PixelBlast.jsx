...
const PixelBlast = ({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      // Check if WebGL context is lost before disposing
      ...
      t.renderer.dispose();
          ...
          // Silently ignore disposal errors if context is already lost
          console.warn('Error disposing WebGL resources:', error);
        }
      }
